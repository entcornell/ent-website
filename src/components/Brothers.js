...
const eboard = [
  ...
  { role: "VP Professional Connects", name: "Diya Sheth", email: "ds2457@cornell.edu", year: "2028", major: "Mechanical Engineering & Entrepreneurship", involvement: "Cornell Assistive Technologies, Startup Consulting at Cornell, Society of Women Engineers", hobbies: "Swimming, Traveling, Robotics, Cafe Hopping", image: "headshots/DiyaSheth-Headshot.jpg", style: {objectPosition: "center 50%"} },
  //{ role: "VP Philanthropy", name: "Christine Zhou", email: "mh2584@cornell.edu", year: "2028", major: "Hotel Administration & Hospitality", involvement: "Mosaic Hospitality Association, Diverse Leaders for Tomorrow, Cornell Rock Climbing Club", hobbies: "TBD", image: "headshots/default-icon.jpg", style: {objectPosition: "center 30%"} },
];
...
const brotherhood = [
  ...
  },
  {
    ...
    members: [
      ...
      {name: "Gabrielle Shepston", email: "gms285@cornell.edu", year: "2029", major: "Economics", involvement: "Cornell Investment Banking Club, Cornell Varsity Track & Field ", hobbies: "Entrepreneurship, Finance, Snowboarding, Climbing, F1", image: "headshots/GabrielleShepston-Headshot.png", style: {objectPosition: "center 35%"} },
