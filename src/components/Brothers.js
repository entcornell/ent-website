...
const eboard = [
  ...
  { role: "VP Recruitment", name: "Finn Clancy", email: "fac49@cornell.edu", year: "2027", major: "Biology & Society/Entrepreneurship", involvement: "ENT, Reis Tennis Center, Biotech off Campus Job", hobbies: "Tennis, Traveling, Weightlifting, Cooking, and Collecting Coins", image: "headshots-fall2025/FinnClancy-Headshot.jpg", style: {objectPosition: "center 30%"}},
  { role: "VP NME", name: "Pradhi Pakkerakari", email: "sp2362@cornell.edu", year: "2027", major: "Computer Science/Data Science", involvement: "Cornell Speech & Debate, Armada, Engineers Without Borders, Cornell Sitara", hobbies: "Cooking, Cars, Gardening, AgriTech", image: "headshots-fall2025/PradhiPakkerakari.png", style:{objectPosition: "center 30%"}},
  { role: "VP NME", name: "Sebastian Dominguez", email: "wd273@cornell.edu", year: "2028", major: "Computer Science/Entrepreneurship", involvement: "EWB Cornell", hobbies: "Travelling, Basketball, Golf, Coding", image: "headshots-fall2025/SebastianDominguez-Headshot.JPG", style:{objectPosition: "center 30%"}},
  { role: "VP Professional Events", name: "Alix Martini", email: "ahm258@cornell.edu", year: "2028", major: "Biomedical Engineering & Entrepreneurship", involvement: "Cornell DEBUT, International Students Association, Triathlon Club, Big Red Sports Network", hobbies: "Sailing, Running, Cooking, Yogurt Bowls, Hiking, Matcha, Swimming", image: "headshots-fall2025/AlixMartini-Headshot.jpg", style: {objectPosition: "center 55%"} },
  ...
  { role: "VP SBC", name: "Mahin Hardaway", email: "mh2584@cornell.edu", year: "2028", major: "Hotel Administration & Hospitality", involvement: "Mosaic Hospitality Association, Diverse Leaders for Tomorrow, Cornell Rock Climbing Club", hobbies: "Baking, Running, Computer Science, Social Consulting", image: "headshots-fall2025/MahinHardaway-Headshot.jpg", style: {objectPosition: "center 30%"} },
  { role: "VP Brotherhood", name: "Jackson Hutchison", email: "jh3227@cornell.edu", year: "2029", major: "AEM/Entrepreneurship, Philosophy Minor", involvement: "Founder of Syndeo, Social Fraternity, Club Golf", hobbies: "Backpacking, Movies, Sports, Running, Minimizing Cortisol", image: "headshots/JacksonHutchison-Headshot.jpeg", style: {objectPosition: "center 10%"} },
  { role: "VP Professional Connects", name: "Olivia Buvanova", email: "omb29@cornell.edu", year: "2029", major: "Economics and Psychology, French Minor", involvement: "Psych and law research lab, Cornell Ballet Club, Cornell Ethics Team, Social Sorority", hobbies: "Music, pickleball, fashion, ballet", image: "headshots/OliviaBuvanova-Headshot.png", style: {objectPosition: "center 15%"} },
  { role: "VP Philanthropy", name: "Christine Zhou", email: "cwz8@cornell.edu", year: "2028", major: "Economics & Information Science", involvement: "Cornell Global Business, Claude Builders, CSA, SWIB, CSSC", hobbies: "Pilates & Sculpt, Volleyball, Ski, Art & Antiquities, Cinema, Languages", image: "headshots/ChristineZhou-Headshot.png", style: {objectPosition: "center 90%"} },
];
...
const brotherhood = [
  ...
  },
  {
    ...
    members: [
      {name: "Shannon Lin", email: "sl3454@cornell.edu", year: "2028", major: "Computer Science/Business", involvement: "Cornell Assistive Technologies, BigRed\\Hacks,  Club Swim, Cornell Sun, Curious Cardinals Representative", hobbies: "Gourmet dining, crocheting, ski, gardening, robotic fabrication, travel, accessibility", image: "headshots-fall2025/ShannonLin-Headshot.jpeg", extra: "Website Coordinator", style: {objectPosition: "center 40%"} },
      ...
      {name: "Anisha Roy", email: "ar2429@cornell.edu", year: "2027", major: "Biomedical Engineering", involvement: "Cornell Bhangra, Engineering World Health", hobbies: "Hiking, Dance, Trying new restaurants", image: "headshots-fall2025/AnishaRoy-Headshot.jpeg", style: {objectPosition: "center 10%"} },
  ...
  },
  {
    ...
    members: [
      ...
      {name: "Neha Patil", email: "nhp36@cornell.edu", year: "2028", major: "Computer Science, Business", involvement: "Cornell Business Analytics, South Asian Business Association, Engineers Without Borders, Pi Beta Phi", hobbies: "DJing, Cooking, Listening to Rap & R&B", image: "headshots-fall2025/NehaPatil-Headshot.png", extra: "Website Coordinator", style:{objectPosition: "center 30%"}},
    ],
  },
  {
    className: "Mu Class",
    members: [
      ...
      {name: "Brooke Wilcox", email: "bmw252@cornell.edu", year: "2028", major: "ILR", involvement: "Cornell Fashion Collective, Alpha Xi Delta", hobbies: "Running, Skiing, Baking, Music, Driving", image: "headshots/BrookeWilcox-Headshot.jpeg", extra: "Social Media Coordinator", style: {objectPosition: "center 35%"} },
      ...
      {name: "Melissa Chowdhury", email: "mc3237@cornell.edu", year: "2028", major: "AEM", involvement: "eLab, Entrepreneurship Club", hobbies: "Cooking, Traveling, Anything Adventurous, Side Quest", image: "headshots/MelissaChowdhury-Headshot.jpeg", style: {objectPosition: "center 35%"} },
      ...
      {name: "Diya Sheth", email: "ds2457@cornell.edu", year: "2028", major: "Mechanical Engineering & Entrepreneurship", involvement: "Cornell Assistive Technologies, Startup Consulting at Cornell, Society of Women Engineers", hobbies: "Swimming, Traveling, Robotics, Cafe Hopping", image: "headshots/DiyaSheth-Headshot.jpg", style: {objectPosition: "center 50%"} },
  ...
  },
  {
    className: "Nu Class",
    members: [
      {name: "Saanvi Rastogi", email: "sr2423@cornell.edu", year: "2029", major: "Hotel Administration with minor in Entrepreneurship", involvement: "Society for Women in Business, AXID Sorority", hobbies: "Tennis, Baking, Ice Cream, Listening to music, traveling", image: "headshots/SaanviRastogi-Headshot.jpg", style: {objectPosition: "center 32%"} },
      {name: "Mihir Steingard", email: "mes492@cornell.edu", year: "2028", major: "Industrial and Labor Relations/Computer Science", involvement: "Cornell Sun Opinion Columnist, Cornell Data Strategy ", hobbies: "Biking, jiu-jitsu, reading, food", image: "headshots/MihirSteingard-Headshot.jpeg", style: {objectPosition: "center 40%"} },
      {name: "Jackson Hutchison", email: "jh3227@cornell.edu", year: "2029", major: "AEM/Entrepreneurship, Philosophy Minor", involvement: "Founder of Syndeo, Social Fraternity, Club Golf", hobbies: "Backpacking, Movies, Sports, Running, Minimizing Cortisol", image: "headshots/JacksonHutchison-Headshot.jpeg", style: {objectPosition: "center 0%"} },
      {name: "Gabrielle Shepston", email: "gms285@cornell.edu", year: "2029", major: "Economics", involvement: "Cornell Investment Banking Club, Cornell Varsity Track & Field", hobbies: "Snowboarding, Climbing, F1", image: "headshots/GabrielleShepston-Headshot.png", style: {objectPosition: "center 35%"} },
      {name: "Lester Larbie", email: "lkl43@cornell.edu", year: "2029", major: "Mechanical Engineering", involvement: "IM sports and NSBE", hobbies: "Basketball, Music, Gym", image: "headshots/LesterLarbie-Headshot.jpg", style: {objectPosition: "center 25%"} },
      {name: "Shruti Goteti", email: "sg2632@cornell.edu", year: "2029", major: "ISST and Business", involvement: "WICC and CVC", hobbies: "outdoor activities, traveling and eating", image: "headshots/ShrutiGoteti-Headshot.png", style: {objectPosition: "center 25%"} },
      {name: "Olivia Buvanova", email: "omb29@cornell.edu", year: "2029", major: "Economics and Psychology, French Minor", involvement: "Psych and law research lab, Cornell Ballet Club, Cornell Ethics Team, Social Sorority", hobbies: "Music, pickleball, fashion, ballet", image: "headshots/OliviaBuvanova-Headshot.png", style: {objectPosition: "center 15%"} },
      {name: "Christine Zhou", email: "cwz8@cornell.edu", year: "2028", major: "Economics & Information Science", involvement: "Cornell Global Business, Claude Builders, CSA, SWIB, CSSC", hobbies: "Pilates & Sculpt, Volleyball, Ski, Art & Antiquities, Cinema, Languages", image: "headshots/ChristineZhou-Headshot.png", style: {objectPosition: "center 90%"} },
    ],
  },
];
...
const alumni = [
  ...
  { name: "Ten Takeda", email: "tt585@cornell.edu", year: "2026", major: "Business Management", involvement: " eLab 2024/25 Cohort", hobbies: "Fitness, Soccer, Travelling, Fashion", image: "headshots/TenTakeda-Headshot.jpeg", style: {objectPosition: "center 30%"} },
