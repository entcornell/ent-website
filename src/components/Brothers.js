...
const brotherhood = [
  ...
  },
  {
    ...
    members: [
      ...
      {name: "Brooke Wilcox", email: "bmw252@cornell.edu", year: "2028", major: "ILR", involvement: "Cornell Fashion Collective, Alpha Xi Delta", hobbies: "Running, Skiing, Baking, Music, Driving", image: "headshots/BrookeWilcox-Headshot.jpeg", extra: "Social Media Chair", style: {objectPosition: "center 35%"} },
