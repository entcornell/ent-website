...
const eboard = [
  ...
  { role: "VP Prof. Connects", name: "Hongjin Fang", email: "hf355@cornell.edu", year: "2028", major: "Bioengineering", involvement: "Sabuncu Lab, IM Basketball & Soccer", hobbies: "Cooking, Sports, Exploring Nature, Chess", image: "headshots/HongjinFang-Headshot.jpg", style: {objectPosition: "center 20%"} },
...
const brotherhood = [
  ...
  },
  {
    ...
    members: [
      ...
      {name: "Noel Blackwell", email: "bwb79@cornell.edu", year: "2028", major: "Economics", involvement: "Social Fraternity, Cornell Capital Club", hobbies: "Golf, F1, Traveling, Reading, Classical Music", image: "headshots/NoelBlackwell-Headshot.JPEG", style: {objectPosition: "center 25%"} },
